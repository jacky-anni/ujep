...
import { showStudents, editStudentsSupp } from "../../actions/StudentAction";
...
const EditStudentsInfoSupp: React.FC<{}> = () => {
  ...
  return (
    <>
      <div className='row'>
        <div className='card'>
          <AppTitle
            title={"Modifier les informations supplementaires"}
            img=''
          />
        </div>
...
export default EditStudentsInfoSupp;
